...
from ai_pr_agent.git_providers.codecommit_client import CodeCommitClient
from ai_pr_agent.algo.types import EDIT_TYPE, FilePatchInfo
from ..algo.utils import load_large_diff
from .git_provider import GitProvider
from ..config_loader import get_settings
from ..log import get_logger
from ai_pr_agent.algo.language_handler import is_valid_file
...
class CodeCommitProvider(GitProvider):
    ...
    def get_repo_settings(self):
        # a local ".ai_pr_agent.toml" settings file is optional
        settings_filename = ".ai_pr_agent.toml"
