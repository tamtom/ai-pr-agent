...
class GithubProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            # contents = self.repo_obj.get_contents(".ai_pr_agent.toml", ref=self.pr.head.sha).decoded_content

            # more logical to take 'ai_pr_agent.toml' from the default branch
            contents = self.repo_obj.get_contents(".ai_pr_agent.toml").decoded_content
            return contents
        except Exception:
            return ""
