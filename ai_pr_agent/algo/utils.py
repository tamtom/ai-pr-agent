...
from ai_pr_agent.algo.token_handler import TokenEncoder
from ai_pr_agent.config_loader import get_settings, global_settings
from ai_pr_agent.algo.types import FilePatchInfo
...
def get_max_tokens(model):
    ...
    if model in MAX_TOKENS:
        ...
        raise Exception(f"MAX_TOKENS must be set for model {model} in ./ai_pr_agent/algo/__init__.py")
...
def get_largest_component(pr_url):
    from ai_pr_agent.tools.pr_analyzer import PRAnalyzer
...
def show_relevant_configurations(relevant_section: str) -> str:
    ...
    markdown_text +="<br>These are the relevant [configurations](https://github.com/Codium-ai/pr-agent/blob/main/ai_pr_agent/settings/configuration.toml) for this tool:\n\n"
