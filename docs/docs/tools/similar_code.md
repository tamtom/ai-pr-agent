...
![similar code global](https://codium.ai/images/ai_pr_agent/similar_code_global2.png){width=768}
...
![code search result single](https://codium.ai/images/ai_pr_agent/code_search_result_single.png){width=768}


`Organization Search`:

![similar code org](https://codium.ai/images/ai_pr_agent/similar_code_org.png){width=768}
...
![analyze similar](https://codium.ai/images/ai_pr_agent/analyze_similar.png){width=768}
...
![similar code global](https://codium.ai/images/ai_pr_agent/similar_code_global.png){width=768}
