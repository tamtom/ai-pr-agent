...
![Describe comment](https://codium.ai/images/ai_pr_agent/describe_comment.png){width=512}

After ~30 seconds, the tool will generate a description for the PR:

![Describe New](https://codium.ai/images/ai_pr_agent/describe_new.png){width=512}
...
![Add table checkbox](https://codium.ai/images/ai_pr_agent/add_table_checkbox.png){width=512}
...
![Diffview table](https://codium.ai/images/ai_pr_agent/diffview-table.png){width=512}

- `true`: A collapsable file comment with changes title and a changes summary for each file in the PR.

![Diffview changes](https://codium.ai/images/ai_pr_agent/diffview_changes.png){width=512}
...
## PR Walkthrough:
ai_pr_agent:walkthrough
```
The marker `ai_pr_agent:type` will be replaced with the PR type, `ai_pr_agent:summary` will be replaced with the PR summary, and `ai_pr_agent:walkthrough` will be replaced with the PR walkthrough.

![Describe markers before](https://codium.ai/images/ai_pr_agent/describe_markers_before.png){width=512}

&rarr;

![Describe markers after](https://codium.ai/images/ai_pr_agent/describe_markers_after.png){width=512}


**Configuration params**:

- `use_description_markers`: if set to true, the tool will use markers template. It replaces every marker of the form `ai_pr_agent:marker_name` with the relevant content. Default is false.
...
Examples for custom labels:
  ...
  - `Main topic:performance` -  ai_pr_agent:The main topic of this PR is performance
  - `New endpoint` -  ai_pr_agent:A new endpoint was added in this PR
  - `SQL query` -  ai_pr_agent:A new SQL query was added in this PR
  - `Dockerfile changes` - ai_pr_agent:The PR contains changes in the Dockerfile
  - ...
...
![Add native custom labels](https://codium.ai/images/ai_pr_agent/add_native_custom_labels.png){width=768}
...
!!! tip "Automation"
   ...
   ```
   the tool will replace every marker of the form `ai_pr_agent:marker_name` in the PR description with the relevant content, where `marker_name` is one of the following:
         * `type`: the PR type.
