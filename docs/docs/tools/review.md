...
![review comment](https://codium.ai/images/ai_pr_agent/review_comment.png){width=512}

After ~30 seconds, the tool will generate a review for the PR:

![review](https://codium.ai/images/ai_pr_agent/review3.png){width=512}
...
![incremental review](https://codium.ai/images/ai_pr_agent/incremental_review_2.png){width=512}
...
![reflection questions](https://codium.ai/images/ai_pr_agent/reflection_questions.png){width=512}

![reflection answers](https://codium.ai/images/ai_pr_agent/reflection_answers.png){width=512}

![reflection insights](https://codium.ai/images/ai_pr_agent/reflection_insights.png){width=512}
...
!!! tip "Possible labels from the review tool"
    ...
    - a `possible security issue` label that detects if a possible [security issue](https://github.com/Codium-ai/pr-agent/blob/tr/user_description/ai_pr_agent/settings/pr_reviewer_prompts.toml#L136) exists in the PR code (`enable_review_labels_security` flag)
